        ...
        <div className="auth-page">
          ...
          <div className="auth-card" style={{ textAlign: 'center' }}>
            ...
            <p className="auth-subheading" style={{ marginBottom: '1.5rem' }}>
              ...
              <span className="auth-email-highlight">{email}</span>. Click it to activate your account.
            </p>
            <button type="button" className="auth-submit" onClick={() => { setDone(false); goLogin() }}>
              Back to log in
            </button>
          </div>
        </div>
          ...
          {!isSignup ? (
            <>
              ...
              <p className="auth-switch">
                ...
                <button type="button" className="auth-switch-link" onClick={goSignup}>
                  Sign up
                </button>
              </p>
            </>
            ...
            <>
              ...
              <p className="auth-subheading">Join Orbiit to report lost and found items</p>
              ...
              <button type="button" className="auth-submit" onClick={handleSignup} disabled={loading}>
              ...
              <p className="auth-switch">
                ...
                <button type="button" className="auth-switch-link" onClick={goLogin}>
                  Log in
                </button>
              </p>
            </>
